...
- `fund_firds` — umbrella-LEI YAML, FIRDS Solr, builds `FundGolden` with the full UCITS five-level hierarchy (promoter → managementCompany → umbrella → subFund → shareClass).
