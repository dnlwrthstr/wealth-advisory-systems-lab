...
*Generated by /sp-plan on 2026-05-18. Plans the implementation of spec-002 (predicate refinement + `replace_paths` marker on merger). 6 phases, ~4h estimated, single serial chain.*
