...
## Securities Domain – Conceptual Model

### High-level Domain Structure

#### Conceptual Map (mindmap)
...
' Core relationships
Instrument "1" -- "1" Issuer : issued by
Instrument "1" -- "0..*" Listing : is listed via
Listing "1" -- "1" TradingVenue : trades on
Listing "1" -- "0..*" MarketData : has

' Issuer hierarchy
Issuer "0..*" --> "0..1" Issuer : ultimate issuer
...
| :--- | :--- | :--- | :--- |
| Cash & Deposits | Collateral Cash | CollateralCash | [collateral_cash.yaml](instrument/collateral_cash.yaml) |
| Cash & Deposits | Collateral Deposit | CollateralDeposit | [collateral_deposit.yaml](instrument/collateral_deposit.yaml) |
| Cash & Deposits | Demand Deposit | DemandDeposit | [demand_deposit.yaml](instrument/demand_deposit.yaml) |
| Cash & Deposits | Escrow Deposit | EscrowDeposit | [escrow_deposit.yaml](instrument/escrow_deposit.yaml) |
| Cash & Deposits | Margin Cash | MarginCash | [margin_cash.yaml](instrument/margin_cash.yaml) |
| Cash & Deposits | Margin Deposit | MarginDeposit | [margin_deposit.yaml](instrument/margin_deposit.yaml) |
| Cash & Deposits | Nostro Account | NostroAccount | [nostro_account.yaml](instrument/nostro_account.yaml) |
| Cash & Deposits | Notice Deposit | NoticeDeposit | [notice_deposit.yaml](instrument/notice_deposit.yaml) |
| Cash & Deposits | Physical Cash | PhysicalCash | [physical_cash.yaml](instrument/physical_cash.yaml) |
| Cash & Deposits | Savings Deposit | SavingsDeposit | [savings_deposit.yaml](instrument/savings_deposit.yaml) |
| Cash & Deposits | Settlement Cash | SettlementCash | [settlement_cash.yaml](instrument/settlement_cash.yaml) |
| Cash & Deposits | Term Deposit | TermDeposit | [term_deposit.yaml](instrument/term_deposit.yaml) |
| Cash & Deposits | Vostro Account | VostroAccount | [vostro_account.yaml](instrument/vostro_account.yaml) |
| Debt Instruments | Asset-Backed Security | AssetBackedSecurity | [asset_backed_security.yaml](instrument/asset_backed_security.yaml) |
| Debt Instruments | Certificate of Deposit | CertificateOfDeposit | [certificate_of_deposit.yaml](instrument/certificate_of_deposit.yaml) |
| Debt Instruments | Commercial Paper | CommercialPaper | [commercial_paper.yaml](instrument/commercial_paper.yaml) |
| Debt Instruments | Convertible Bond | ConvertibleBond | [convertible_bond.yaml](instrument/convertible_bond.yaml) |
| Debt Instruments | Corporate Bond | CorporateBond | [corporate_bond.yaml](instrument/corporate_bond.yaml) |
| Debt Instruments | Covered Bond | CoveredBond | [covered_bond.yaml](instrument/covered_bond.yaml) |
| Debt Instruments | Government Bond | GovernmentBond | [government_bond.yaml](instrument/government_bond.yaml) |
| Debt Instruments | Inflation-Linked Bond | InflationLinkedBond | [inflation_linked_bond.yaml](instrument/inflation_linked_bond.yaml) |
| Debt Instruments | Mortgage | Mortgage | [mortgage.yaml](instrument/mortgage.yaml) |
| Debt Instruments | Mortgage-Backed Security | MortgageBackedSecurity | [mortgage_backed_security.yaml](instrument/mortgage_backed_security.yaml) |
| Derivatives | Call Option | CallOption | [call_option.yaml](instrument/call_option.yaml) |
| Derivatives | Credit Default Swap | CreditDefaultSwap | [credit_default_swap.yaml](instrument/credit_default_swap.yaml) |
| Derivatives | Equity Swap | EquitySwap | [equity_swap.yaml](instrument/equity_swap.yaml) |
| Derivatives | Forward | Forward | [forward.yaml](instrument/forward.yaml) |
| Derivatives | Future | Future | [future.yaml](instrument/future.yaml) |
| Derivatives | FX Forward | FXForward | [fx_forward.yaml](instrument/fx_forward.yaml) |
| Derivatives | FX Option | FXOption | [fx_option.yaml](instrument/fx_option.yaml) |
| Derivatives | FX Swap | FXSwap | [fx_swap.yaml](instrument/fx_swap.yaml) |
| Derivatives | Interest Rate Swap | InterestRateSwap | [interest_rate_swap.yaml](instrument/interest_rate_swap.yaml) |
| Derivatives | Put Option | PutOption | [put_option.yaml](instrument/put_option.yaml) |
| Derivatives | Total Return Swap | TotalReturnSwap | [total_return_swap.yaml](instrument/total_return_swap.yaml) |
| Equities | Equity | Equity | [equity.yaml](instrument/equity.yaml) |
| Equities | Common Stock | CommonStock | [common_stock.yaml](instrument/common_stock.yaml) |
| Equities | Depositary Receipt | DepositaryReceipt | [depositary_receipt.yaml](instrument/depositary_receipt.yaml) |
| Equities | Participation Certificate | ParticipationCertificate | [participation_certificate.yaml](instrument/participation_certificate.yaml) |
| Equities | Preferred Stock | PreferredStock | [preferred_stock.yaml](instrument/preferred_stock.yaml) |
| Equities | Rights | Rights | [rights.yaml](instrument/rights.yaml) |
| Equities | Tracking Stock | TrackingStock | [tracking_stock.yaml](instrument/tracking_stock.yaml) |
| Equities | Warrants | Warrants | [warrants.yaml](instrument/warrants.yaml) |
| Funds | ETF | ExchangeTradedFund | [etf.yaml](instrument/etf.yaml) |
| Funds | Hedge Fund | HedgeFund | [hedge_fund.yaml](instrument/hedge_fund.yaml) |
| Funds | Money Market Fund | MoneyMarketFund | [money_market_fund.yaml](instrument/money_market_fund.yaml) |
| Funds | Mutual Fund | MutualFund | [mutual_fund.yaml](instrument/mutual_fund.yaml) |
| Funds | Private Equity Fund | PrivateEquityFund | [private_equity_fund.yaml](instrument/private_equity_fund.yaml) |
| Funds | Real Estate Fund | RealEstateFund | [real_estate_fund.yaml](instrument/real_estate_fund.yaml) |

- [Financial Instrument YAML Definition](FinancialInstrument.yml)
- [Financial Instrument Base YAML Definition](FinancialInstrumentBase.yml)
